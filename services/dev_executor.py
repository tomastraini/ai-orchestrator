...
def _resolve_cwd(scope_root: str, raw_cwd: str) -> str:
    ...
    # Normalize common PM output style like "projects/my-app".
...
def execute_dev_tasks(
    ...
    *,
    ...
    """
    Execute developer tasks sequentially with strict scope guard.
    Returns: (execution_logs, touched_paths, errors)
    """
    logs: List[str] = []
