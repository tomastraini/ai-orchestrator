...
- Setup strategy is selected adaptively (standardized setup vs manual construction) with telemetry rationale instead of defaulting to manual file creation.
